...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-05-2025 a las 22:23:35
...
INSERT INTO `core` (`id`, `bloqueo`, `domicilio`, `tel1`, `tel2`, `email`, `atencion`, `rs_fb`, `rs_insta`, `rs_wp`, `wp_msj`, `maps`, `fh_actualizacion`) VALUES
(1, 0, 'Calle Huerta Caoba 100 Tlaquepaque, Jalisco, México', '6666666666', '1234567890', 'elmasperronaqui@gmail.com', 'Lunes a viernes de 8:30 am a 6:30 pm', 'wwwfakefb.com', 'wwwfakeig.com', '3322523419', 'Estas Halbando a MyCom, que rollo?', 'https://www.google.com/maps?q=20.610417961359023,-103.30325514078142', '2025-05-01 14:21:15');
...
(6, 'CPRO', 1, 1, 3, 'CAT', 'Sitio Web', 'sitioweb', 'fas fa-list-ul', 'catalogs/website.php', 1, 'Programas'),
