...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2025 a las 19:44:12
...
INSERT INTO `actividades` (`id`, `folio`, `c_tipo_act`, `id_cliente`, `c_prioridad`, `c_clasifica_act`, `descripcion`, `comentario`, `notas`, `dispositivo`, `id_usuario_resp`, `f_plan_i`, `f_plan_f`, `fh_captura`, `id_usuario_captura`, `fh_finaliza`, `id_usuario_finaliza`, `calificacion`) VALUES
(1, '25T010001', 'TICK', 1, 'U', 'CCTV', 'pruebas', '', '', '', 1, '0000-00-00', '0000-00-00', '2025-03-22 00:04:17', 5, '2025-03-22 00:04:17', 5, 0);
...
INSERT INTO `act_c_clientes` (`id`, `rfc`, `alias`, `razon_social`, `domicilio`, `contacto`, `correo`, `telefono`) VALUES
(1, 'PTR', 'Plastic', 'Plastic Trends SAPI de CV', 'Dr Roberto Michel 750', 'Juan Garcia', 'juan.garcia@plastictrends.com.mx', '3323101175');
...
(11, 'CCLI', 1, 3, 0, 'CAT', 'Clientes', 'clientes', 'fa-home', '', 1, 'Clientes'),
...
(1, 'Luis Grardoa', 'Saucedo', 'Perez', '', 'SPUS', '2025-02-21 02:15:17', 'cronobreak', '65402f90ef3ceb04c9a50fe3b5aa895d', 'lsaucedolucas@gmail.com', 1, '2025-03-05 21:19:26', 0),
...
(3, 'ADUS', 'Administrador', '2025-03-18 17:38:10', 1),
