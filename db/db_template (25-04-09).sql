...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2025 a las 02:47:51
...
(1, 'PTRKA', 'Plastic trends', 'Plastic Trends SAPI de CV', 'Dr Roberto Michel 750', 'Juan Garcia', 'juan.garcia@plastictrends.com.mx', '3323101175', 1, NULL, '', NULL, 'client_1_1744167854.jpg'),
...
INSERT INTO `core_feriados` (`fecha`, `nombre`, `es_recurrente`, `fh_registro`, `activo`) VALUES
('2025-01-01', 'Año Nuevo', 1, NULL, 1),
('2025-01-04', 'TEST', 1, '2025-04-09 18:34:42', 1),
('2025-02-03', 'Día de la Constitución (primer lunes de febrero)', 1, NULL, 1),
('2025-03-17', 'Natalicio de Benito Juárez (tercer lunes de marzo)', 1, NULL, 1),
('2025-04-11', 'prueba2', 1, '2025-04-09 18:25:12', 0),
('2025-04-18', 'prueba', 1, '2025-04-09 18:20:24', 0),
('2025-04-21', 'prueba 2', 1, '2025-04-09 18:22:52', 0),
('2025-04-26', 'asas', 1, '2025-04-09 18:28:44', 0),
('2025-05-01', 'Día del Trabajo', 1, NULL, 1),
('2025-09-16', 'Día de la Independencia', 1, NULL, 1),
('2025-11-17', 'Día de la Revolución (tercer lunes de noviembre)', 1, NULL, 1),
('2025-12-25', 'Navidad', 1, NULL, 1);
...
CREATE TABLE `core_horarios_laborales` (
  ...
  `hr_comida` decimal(10,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(1, '00:00:00', '23:59:59', 0, 0),
(2, '08:00:00', '18:00:00', 1, 0),
(3, '08:00:00', '18:00:00', 1, 0),
(4, '08:00:00', '18:00:00', 1, 0),
(5, '08:00:00', '18:00:00', 1, 0),
(6, '08:00:00', '18:00:00', 1, 0),
(7, '09:00:00', '13:00:00', 1, 0);
...
(23, 'jose', 'maria', 'pelayo', 'user_23_1744165392.jpg', 'SPUS', '2025-03-29 08:27:35', 'pelayo', 'e49ef5899582a8a124c53e51120ce6d7', 'jose.pelayo@mycom.com.mx', 1, NULL, 0, ''),
