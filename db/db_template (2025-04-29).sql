...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2025 a las 04:41:40
...
CREATE TABLE `core` (
  ...
  `rs_fb` varchar(250) NOT NULL,
  `rs_insta` varchar(250) NOT NULL,
  `rs_wp` varchar(250) NOT NULL,
  `wp_msj` varchar(500) NOT NULL,
...
INSERT INTO `core` (`id`, `bloqueo`, `domicilio`, `tel1`, `tel2`, `email`, `atencion`, `rs_fb`, `rs_insta`, `rs_wp`, `wp_msj`, `maps`) VALUES
(1, 0, 'Calle Franz Schubert # 5156, Res. La Estancia, Zapopan, Jal., C.P: 45030', '(33)2305-9595', '(33)2305-9598', 'contacto@mycom.com.mx', 'Lun - Sab 8:00 - 17:30', 'https://www.facebook.com/share/16AfgnHWRD/', '', '3332018668', 'Estas Halbando a MyCom, que rollo?', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7466.09905192049!2d-103.427515!3d20.667564!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8428aea266fa8721%3A0x84ba89585720bb01!2sFranz%20Schubert%205156%2C%20La%20Estancia%2C%2045030%20Zapopan%2C%20Jal.%2C%20M%C3%A9xico!5e0!3m2!1ses-419!2sus!4v1745978117463!5m2!1ses-419!2sus\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>');
